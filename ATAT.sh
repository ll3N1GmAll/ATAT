...
options=("Windows DBD Reverse Shell" "Android" "Quit") #"Linux/NetBSD/FreeBSD/OpenBSD DBD Reverse Shell" "Linux/NetBSD/FreeBSD/OpenBSD DBD Bind Shell")
select opt in "${options[@]}"
do
    case $opt in
...
PS3='Enter your choice 3=QUIT: '
options=("Dependencies" "DBD Installer" "Quit")
select opt in "${options[@]}"
do
    case $opt in
        "Dependencies")
